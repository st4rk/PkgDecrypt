...
int main( int argc, char **argv ) {
    ...
    return 0;
force_quit:
    fprintf( stderr, "Invalid file format detected. If you sure that file is correct, use --force to produce zRIF regardless of file validation result." );
    return 1;
}